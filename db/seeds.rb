...
User.create(first_name: 'John', last_name: 'Doe', email: 'johnd@hotmail.com', current_city: 'Oakland', img: 'https://support.plymouth.edu/kb_images/Yammer/default.jpeg', password: "123", email_confirmed: true)
User.create(first_name: 'Bob', last_name: 'Smith', email: 'bob@gmail.com', current_city: 'San Francisco', img: 'https://support.plymouth.edu/kb_images/Yammer/default.jpeg', password: "123", email_confirmed: true)
User.create(first_name: 'Jennifer', last_name: 'Sarkin', email: 'jsarkin@geocities.com', current_city: 'San Francisco', img: 'https://support.plymouth.edu/kb_images/Yammer/default.jpeg', password: "123", email_confirmed: true)
